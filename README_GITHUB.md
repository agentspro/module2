...
Олександр Денисюк - AI.Agents.PRO курс 2025

---

**Примітка**: 
Всі тести вже виконані, результати знаходяться в `results/`. Для власного тестування просто запустіть відповідний demo скрипт з вашими PDF документами.
